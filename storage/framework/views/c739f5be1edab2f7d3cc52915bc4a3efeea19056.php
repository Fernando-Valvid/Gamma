...
} elseif ($_instance->childHasBeenRendered('UxOdMy6')) {
    $componentId = $_instance->getRenderedChildComponentId('UxOdMy6');
    $componentTag = $_instance->getRenderedChildComponentTagName('UxOdMy6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UxOdMy6');
} else {
    $response = \Livewire\Livewire::mount('contact');
    $html = $response->html();
    $_instance->logRenderedChild('UxOdMy6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\Administrador\OneDrive\Escritorio\Nuevo grupo\resources\views/layouts/app.blade.php ENDPATH**/ ?>