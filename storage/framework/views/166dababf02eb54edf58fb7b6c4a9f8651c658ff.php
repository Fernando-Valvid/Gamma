...
} elseif ($_instance->childHasBeenRendered('YG3P0QR')) {
    $componentId = $_instance->getRenderedChildComponentId('YG3P0QR');
    $componentTag = $_instance->getRenderedChildComponentTagName('YG3P0QR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YG3P0QR');
} else {
    $response = \Livewire\Livewire::mount('contact');
    $html = $response->html();
    $_instance->logRenderedChild('YG3P0QR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\Estadia\pyxis\resources\views/layouts/app.blade.php ENDPATH**/ ?>