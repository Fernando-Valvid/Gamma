    ...
    <section id="about">
                        ...
                        <div class="alazea-service-area mb-100">
                            ...
                            <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                                ...
                                <div class="service-content">
                                    <p style="font-family:Calibri Light; font-size: 20px; text-align: justify;">{!! $subcategoria->introduccion !!}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="description_area">
                <p style="font-family:Calibri Light; font-size: 20px; text-align: justify;">{!! $subcategoria->descripcion !!}</p><br>
            </div>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="description_area">
                <p style="font-family:Calibri Light; font-size: 20px; text-align: justify;">{!! $subcategoria->contenido !!}</p>
                <br>
            </div>
        </div>
        <div class="container">
            ...
            <div class="description_area">
                <p style="font-family:Calibri Light; font-size: 20px; text-align: justify;">{!! $subcategoria->diferenciadores !!}</p><br>
            </div>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="description_area">
                <p style="font-family:Calibri Light; font-size: 20px; text-align: justify;">{!! $subcategoria->carac_adi !!}</p><br>
            </div>
        </div>
    </section>
    <div class="row">
